...
HARD_REJECT_SIGNALS = [
    ...
    'rfic', 'analog design', 'mixed signal', 'mixed-signal',
    'digital design engineer', 'dft engineer', 'design verification',
    'dry etch', 'dram design', 'soi design',
    'optoelectronics', 'electronic design', 'electrical test',
    'characterization engineering', 'post-silicon', 'silicon validation',
    ...
    'product supply', 'product test engineer', 'equipment development',
    'powertrain controls',
    ...
    if any(s in t for s in HARD_REJECT_SIGNALS):
        ...
        if has_keep and not any(
            ...
            for s in (
                ...
                'optoelectronics', 'electronic design', 'electrical test',
                'characterization engineering', 'post-silicon', 'silicon validation',
                'product test engineer', 'equipment development',
                'powertrain controls',
...
def is_in_scope_listing_title(title, table=None):
    ...
    Do not require a fixed CS/IS/SWE keyword allowlist — that falsely rejected
    MotS, SWE, AIML Resident, programmer analyst, etc. Hard rejects still apply.
    """
